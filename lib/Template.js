...
if(typeof window=='undefined')
{
    ...
    var RenderHelper = (require||0)("./RenderHelper.js") ;
...
module.exports = function(path,generator)
{
	this.filePath = path ;
	this.window = null ;
	this.generator = generator || Generator && Generator.singleton ;
	this.renderer = null ;
	this.helper = RenderHelper && RenderHelper.singleton() ;
...
module.exports.prototype.compile= function(generator,callback)
{
	...
	try{
        ...
        this.emit("compiled",this).done(callback) ;
	}catch(e){
...
module.exports.prototype.render= function(model,callback,buff)
{
    ...
    Steps(
        function(){
            if( !tpl.renderer )
            {
                tpl.compile(null,this.hold()) ;
            }
        }
        , function(){
            try{
                tpl.renderer( model, buff||new RenderBuffer, this.hold(), require ) ;
            }catch(e){
