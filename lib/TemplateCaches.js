...
module.exports =function(templateClass,generator)
{
	...
	this.renderHelper = require("octemplate/lib/RenderHelper.js") ;
...
module.exports.prototype.template = function(filename,callback,from)
{
	...
	{
        var caches = this ;
		this._caches[filepath] = new this._tempateclass( filepath, this.generator, this.renderHelper ) ;
        var cache = false ;
	}
	else
	{
