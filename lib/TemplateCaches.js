...
module.exports.prototype.createFormString = function(tplContent,callback){
    var tpl = new this._tempateclass(undefined,this.generator,this.helper) ;
    tpl._tplid = this._tplid++ ;
    tpl._readTemplateFile = function(callback){
        callback(null,tplContent) ;
    } ;
    return tpl.load(callback) ; ;
} ;
